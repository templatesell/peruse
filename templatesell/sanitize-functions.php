 ...
 */
function peruse_sanitize_checkbox( $checked ) {
	// Boolean check.
 ...
 */
function peruse_sanitize_select( $input, $setting ) {
 ...
 *                    the setting default.
 */
function peruse_sanitize_number_range( $number, $setting ) {
 ...
 *  @since Springy 1.0.0
 */
if (!function_exists('peruse_sanitize_number')) :
    function peruse_sanitize_number($input)
    {
