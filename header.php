...
<div id="page" class="site ">
	<a class="skip-link screen-reader-text" href="#content"><?php esc_html_e( 'Skip to content', 'peruse' ); ?></a>

	<?php
    /**
     * Hook - peruse_action_header.
     *
     * @hooked peruse_add_main_header - 10
     */
    do_action( 'peruse_action_header' );
    ?>
	 ...
	 <?php if ($enable_slider == 1 && (is_home() || is_front_page())) { ?>
        <section class="slider-wrapper">
            ...
            * Slider Section Hook
            */
                do_action('peruse_action_slider');
            ?>
        </section>
    <?php } ?>
